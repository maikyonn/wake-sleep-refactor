...
srun /home/software/anaconda3/2023.07/bin/torchrun \
    ...
    train_form_classifier.py --data_dir datasets/synth_midi_90k --encoder_ckpt checkpoints/enc_bs128_lr1e-05_seq4096_node1917_20250504_123719/enc-epoch=03-step=1313-val_nt_xent=0.000.ckpt --num_workers 128 